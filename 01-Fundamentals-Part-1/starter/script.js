...
switch (day) {
    case 'monday': // day === 'monday'
        ...
        break;
    // why? because without the break, the code keeps executing.
    // so instead of the console printing: "Plan course...\nGo to cod...", it prints them + "Prepare th.."
    case 'tuesday':
...
// let's do the exact same but with if/else statements:
...
// The purpose of this is to write the if/else statement ALL in ONE LINE of code.
// TERNARY = 3 (condition, if, else)

//Cleaner code:
const drink = age >= 18 ? 'wine' : 'water';
console.log(drink);

//Same code but with the actual if/else statements:
let drink2;
if (age >= 18) {
    drink2 = 'wine';
} else {
